"""
Structural discipline engine.

Specialized for concrete, reinforcement, formwork, and foundations.
"""
...
_PROMPTS_DIR = _REPO_ROOT / "knowledge" / "prompts" / "estructura"
_RULES_PATH = Path(__file__).resolve().parent / "rules.json"


class EstructuraEngine:
    """Structural discipline engine."""

    def __init__(self) -> None:
        self.config = DisciplineConfig(
            discipline_id="estructura",
            ...
            item_types={
                ...
                "column_concrete_volume", "column_volume", "column_area", "column_length",
                "column_count", "column_formwork_area_hint", "column_reinforcement_kg",
            ...
            bc3_chapter_filter={"01", "02", "03", "04", "05", "06", "07", "09"},
        )
...
register_engine("estructura", EstructuraEngine)
