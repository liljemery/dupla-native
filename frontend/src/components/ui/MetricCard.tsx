...
export function MetricCard({
  ...
  return (
    <div
      className={`rounded-2xl border px-5 py-4 shadow-[var(--shadow-toolbar)] transition-all hover:-translate-y-0.5 hover:shadow-[var(--shadow-elevated)] ${accentStyles[accent]} ${className}`}
    >
