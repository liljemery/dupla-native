...
export function ProjectWorkspaceDashboard({
  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col overflow-hidden">
      ...
      <div className="flex shrink-0 flex-col gap-3 rounded-2xl border border-black/10 bg-white px-4 py-3 shadow-(--shadow-card) sm:flex-row sm:items-center sm:justify-between">
