      ...
      <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
        <div className="min-w-0">
          <div className="flex items-center gap-2">
            <Link
              to="/app/projects"
              className="inline-flex size-9 shrink-0 items-center justify-center rounded-xl border border-black/10 bg-white text-muted shadow-sm transition-colors hover:bg-black/3 hover:text-ink"
        ...
        <div className="flex flex-wrap items-center justify-end gap-2">
          ...
          <Link
            to="/app/tutoriales"
            className="inline-flex size-10 items-center justify-center rounded-xl border border-black/10 bg-white text-muted shadow-sm transition-colors hover:bg-black/3 hover:text-ink"
