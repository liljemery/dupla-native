...
PERMISSION_CATALOG: tuple[PermissionDef, ...] = (
    ...
    PermissionDef("lifecycle.management_review", "Aprobar presupuesto (Gerencia)", "Ciclo de vida"),
    PermissionDef("lifecycle.approve_specs", "Aprobar especificaciones", "Ciclo de vida"),
    PermissionDef("projects.archive", "Archivar y restaurar proyectos", "Proyectos"),
    PermissionDef("projects.view_archived", "Ver proyectos archivados", "Proyectos"),
    PermissionDef("projects.delete", "Eliminar proyectos archivados", "Proyectos"),
