...
def build_ai_assistant_system_prompt() -> str:
    ...
    return (
        ...
        "- Ese apartado incluye **estado por fase del flujo** (arranque, archivos, revisión, pliego, presupuesto, gerencia, etc.) "
        "y una sección **«Qué falta para avanzar al siguiente paso»**: usala para preguntas del tipo "
        "«¿por qué no puedo avanzar?» o «¿qué me falta?».\n\n"
