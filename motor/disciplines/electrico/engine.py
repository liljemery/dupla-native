...
logger = logging.getLogger("dupla.disciplines.electrico")

_REPO_ROOT = Path(__file__).resolve().parent.parent.parent
_PROMPTS_DIR = _REPO_ROOT / "knowledge" / "prompts" / "electrico"


class ElectricoEngine:
    """Electrical discipline engine."""

    def __init__(self) -> None:
        self.config = DisciplineConfig(
            discipline_id="electrico",
            display_name="El\u00e9ctrico",
            prompts_dir=_PROMPTS_DIR,
            chapter_config=build_chapter_config(),
            item_types={"fixture_count"},
...
register_engine("electrico", ElectricoEngine)
